...
loan_data = pd.read_csv("C:\Users\aladi\OneDrive\Desktop\loan_train.csv",index_col=False)
...
test_data = pd.read_csv("C:\Users\aladi\OneDrive\Desktop\loan_train.csv")
test_data.head()
